...
abstract class CActiveRecord extends CModel
{
	...
	public function __construct($scenario='insert', $tableName = '')
	{
		...
		$this->_attributes=$this->getMetaData($tableName)->attributeDefaults;
	 ...
	 */
	public static function model($className=__CLASS__, $tableName = "")
	{
	...
	public function getMetaData($tableName = "")
	{
		...
		if(!array_key_exists($className,self::$_md))
		{
			...
			self::$_md[$className]=new CActiveRecordMetaData($this, $tableName);
		}
